...
public static partial class MessageLocationSenderOneTypeSystem
{
    ...
    public static void Check(this MessageLocationSenderOneType self)
    {
    ...
    public static async ETTask<IResponse> Call(this MessageLocationSenderOneType self, long entityId,
